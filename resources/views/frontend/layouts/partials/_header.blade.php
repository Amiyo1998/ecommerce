                ...
                <div class="header__cart">
                    @php
                        $total = App\Models\Cart::all()->where('ip_address', request()->ip())->sum(
                            ...
                            $quantity = App\Models\Cart::all()->where('ip_address', request()->ip())->sum('product_qnty');
                    @endphp
                    <ul>
                        <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                        <li><a href="{{ route('carts.index')}}"><i class="fa fa-shopping-bag"></i> <span>{{ $quantity }}</span></a></li>
                    </ul>

                ...
                <table class="table table-striped">
                    <thead>
                        <tr class="border border-2">
                            ...
                            <th class="border border-2">Tag Name</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border border-5">
                            ...
                            <td class="border border-5">{{ $tag->name }}</td>
                            <td class="border border-5">
                                <a href="{{ route('tags.edit', $tag->id)}}"><i class="fas fa-edit bg-primary text-light px-2 py-2" style="font-size: 17px;"></i></i></a>
                                <form action="{{ route('tags.destroy',$tag->id )}}" method="POST" class="d-inline-block border rounded-3 ">
                                    @csrf
                                    @method('DELETE')

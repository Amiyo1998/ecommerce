                ...
                <table class="table table-striped">
                    <thead>
                        <tr class="border border-2">
                            ...
                            <th class="border border-2">Keyword Name</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border border-5">
                            ...
                            <td class="border border-5">{{ $cat->slug }}</td>
                            <td class="border border-5">{{ $cat->keywords }}</td>
                            <td class="border border-5"><img src="{{ asset('storage/'.$cat->image) }}" alt="" width="50px" height="30px"></td>
